...
public partial class Sent : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        System.Data.DataTable dt = dbo.getdata("Select * from mails where fromid = '" + Session["uid"].ToString() + "' and status='open'");
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            s += "<td><a href='Sent.aspx?delid=" + dt.Rows[i]["Id"].ToString() + "'>Delete</a>";
