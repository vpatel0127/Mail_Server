...
public partial class search : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        System.Data.DataTable dt = dbo.getdata("Select * from mails where toid = '" + Session["uid"].ToString() + "' and status='open' and subject like '%"+ Request["t1"]+"%'");
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            s += "<td><a href='search.aspx?delid=" + dt.Rows[i]["Id"].ToString() + "'>Delete</a>";
